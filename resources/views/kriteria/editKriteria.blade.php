            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('updateKriteria',$krt->id)}}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="nama">Nama Kriteria</label>
                                    <input type="text" name="nama_kriteria" id="nama_kriteria" value="{{$krt->nama_kriteria}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="bobot" id="bobot" step=0.01 value="{{$krt->bobot}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name='label' class="form-control" id="sel1" value="{{$krt->jenis_kriteria}}">
